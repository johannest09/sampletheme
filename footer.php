						...
						<div class="row">
							...
							<div class="span4">
								<div class="shortcut-links">
									...
									<div class="row">
										<div class="span6"><nav><?php wp_nav_menu(array('menu' => 'footerLinksLeft', 'container' => '')); ?></nav></div>
										<div class="span6"><nav><?php wp_nav_menu(array('menu' => 'footerLinksRight', 'container' => '')); ?></nav></div>
									</div>
								</div>
							</div>
						</div>
